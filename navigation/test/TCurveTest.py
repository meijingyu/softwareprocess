...
#         self.assertAlmostEquals(myT.f(1, 5), 0.578703704)
  ...
  #happy test_FA01   
    def test_Intergrate_1(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,4,myT.f_1),0.5,3)
    def test_Intergrate_2(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,4,myT.f_2),1.0/3,10)
    def test_Intergrate_3(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,self.nominalN,myT.f_3),1.0/7,3)
    def test_Intergrate_4(self):
        myT = T.TCurve(self.nominalN)
        self.assertAlmostEquals(myT.integrate(1.0,self.nominalN,myT.f_4),1.000/101,3)
        
    def test_Tcurve(self):
        myT = T.TCurve(6)
